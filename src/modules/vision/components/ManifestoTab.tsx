  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-start justify-between mb-4">
        <div>
          <h2 className="text-base font-semibold text-gray-800">Personal Manifesto</h2>
          <p className="text-xs text-gray-400 mt-0.5">Your declaration of how you live, what you stand for, and what you refuse to accept. Use blank lines to separate paragraphs.</p>
        </div>
        {!editing && (
